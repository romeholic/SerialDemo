...
public class MainMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button buttonSend = (Button)findViewById(R.id.SendButton);
		buttonSend.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, SendingDataActivity.class));
			}
		});

		final Button buttonWeloo = (Button)findViewById(R.id.WelooButton);
		buttonWeloo.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(MainMenu.this, WelooTestActivity.class));
			}
		});
